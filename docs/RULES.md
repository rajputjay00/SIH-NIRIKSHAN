...
|---|---|---|---|---|---|
| **R01** | `Rule 6(1)(a)` | Manufacturer / Packer / Importer Name & Address | high | `Implemented` | FAIL, PASS |
| **R02** | `Rule 10(1) Expl. I` | 6-Digit Postal Index Number (PIN) | medium | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R03** | `Rule 6(1)(a) Expl. I–II` | Responsible Entity Identification | low | `Implemented` | FAIL, PASS |
| **R04** | `Rule 6(1)(aa)` | Country of Origin for Imports | high | `Implemented` | FAIL, PASS |
| **R05** | `Rule 6(1)(b)` | Common or Generic Name of Commodity | low | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R06** | `Rule 6(1)(c) read with Rule 12 & 13` | Net Quantity in Standard SI Units | high | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R07** | `Rule 13(4)` | Prohibition of Count Words (Dozen/Gross/Score) | medium | `Implemented` | FAIL, N/A, PASS |
| **R08** | `Rule 13(5)` | Standard SI Unit Symbols Only | medium | `Implemented` | FAIL, N/A, PASS |
| **R09** | `Rule 12(6)` | Prohibition of Qualifier Words in Net Quantity | medium | `Implemented` | FAIL, N/A, PASS |
| **R10** | `Rule 6(1)(d)` | Month and Year of Manufacture / Packing / Import | medium | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R11** | `Rule 6(1)(da)` | Best Before / Expiry Date Declaration | medium | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R12** | `Rule 6(1)(e) read with Rule 2(m)` | Maximum Retail Price (MRP) & Tax Declaration | high | `Implemented` | FAIL, NEEDS_REVIEW, PASS |
| **R13** | `Rule 6(1)(e)` | MRP Fractional Paise Rounding (.00 or .50) | low | `Implemented` | FAIL, PASS |
